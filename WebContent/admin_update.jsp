			      ...
			      <div class="container">
			        ...
			        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
			          <ul class="nav navbar-nav">
			            ...
			            <li class="active"><a href="admin_update.jsp" title="Update"> Editar item </a></li>
	       ...
	       <div class="col-md-6 col-md-offset-3">       
	       	<div class="box box-warning">
	            <div class="box-header with-border">
	              <h3 class="box-title">Editar um produto</h3>
	            </div>
	            <form class="form-horizontal" name="admin" action="Controller" method="post">
	              <div class="box-body">
                    ...
                    <span style="color:green"> 
                     <b> Produto editado com Sucesso!!  </b>
                      </span> 
                      
                     <% } if(db_update_result.equals("failure")) { %>
                     <span style="color:red">
                      <b> Falha ao editar :( <br> Tente novamente!   </b> 
                      </span> 
                     <% }} %>
                    ...
                    <% if (classifier_name != null || classifier_name != "") {%>
                    	<div class="form-group2">
		                  <label for="Name" class="col-sm-2 control-label">ID do produto:</label>
		                  <div class="col-sm-10">
	              ...
	              <div class="box-footer">
	                <button type="submit" value="Update" name="admin_db_changes" class="btn btn-default pull-right" >Editar</button>
	              </div>                      
                    <% }%>
             		</form>
        		</div>         
