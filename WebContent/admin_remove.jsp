			      ...
			      <div class="container">
			        ...
			        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
			          <ul class="nav navbar-nav">
			            ...
			            <li class="active"><a href="admin_remove.jsp" title="Delete"> Deletar item </a></li>
	       ...
	       <div class="col-md-6 col-md-offset-3">       
	       	<div class="box box-info">
	            <div class="box-header with-border">
	              <h3 class="box-title">Deletar um produto</h3>
	            </div>
	              ...
	              <div class="box-body"> 
                    <% if(db_deletion_result!=null){if(db_deletion_result.equals("success")){%>
                     <span style="color:green">  <b> Produto deletado com sucesso!!  </b> </span> 
                     <% } if(db_deletion_result.equals("failure")) { %>
                     <span style="color:red">  <b> Falha ao excluir:( <br> Tente novamente!   </b> </span> 
                     <% }} %>
                  ...
                  <div class="radio col-sm-12">
                    <label>
                      <input type="radio" name="admin_radio_delete" value="id" required>
                      ID do Produto
                    </label>
                  </div>
                  <div class="radio col-sm-12">
                    <label>
                      <input type="radio"  name="admin_radio_delete" value="name" required>
                      Nome do Produto
                    </label>
                  </div>
                </div>
                <div class="form-group2">
                  <label for="Name" class="col-sm-2 control-label">Id ou Nome:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="admin_id_or_name"  required />
                  </div>
                </div>
                </div>
	              </div>
	              <div class="box-footer">
	                <button type="submit" value="Update" name="admin_db_delete" class="btn btn-default pull-right" >Excluir</button>
	              </div>      
                    <% }%>
                    </form>
        		</div>         
